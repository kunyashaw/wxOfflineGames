...
class FarmMatch extends Game {
  ...
  draw() {
    this.clear(); this.ctx.fillStyle = '#abebc6'; this.ctx.fillRect(0, 0, this.width, this.height);
    for (let r = 0; r < this.rows; r++) {
      for (let c = 0; c < this.cols; c++) {
    ...
    this.ctx.fillStyle = '#1e8449'; this.ctx.font = '14px sans-serif'; this.ctx.textAlign = 'center';
